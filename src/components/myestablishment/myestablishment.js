...
class Myestablishment extends Component {
  ...
  nullEstblishment = () => {
    return (
    <section className="u-align-left u-clearfix nullestablishment-section" id="sec-ee08">
  <div className="u-clearfix u-sheet u-valign-middle u-sheet-1">
    <div className="u-align-center u-container-style u-grey-5 u-group u-group-1">
      <div className="u-container-layout u-valign-middle u-container-layout-1">
        <h1 className="u-text u-text-default u-text-1">คุณไม่มีร้านค้า</h1>
        <a href className="u-btn u-btn-round u-button-style u-color-scheme-summer-time u-color-style-multicolor-1 u-palette-2-base u-radius-50 u-btn-1">กลับสู่หน้าแรก</a>
      </div>
    </div>
  </div>
</section>)
          ...
          .then((result) => {
            ...
            httpClient
              ...
              .then((response) => {
                ...
                this.setState({data: null, isFetching: false});
              }
              });
          });
      } else {
  ...
  render() {
    ...
    return (
      ...
      >
        ...
        <p className="u-text label-text"><a href="" onClick={() => this.props.history.push('/home/')}>หน้าแรก</a> / ร้านค้าของฉัน</p>
            ...
            <div className="u-tab-content">
              ...
              >
                <div className="u-container-layout u-container-layout-1">
                  ...
                  <a
                  onClick={() => this.props.history.push(`/editestabilishment`)}
                    href=""
    ...
    {(isFetching == false && data == null) && (<section className="u-align-left u-clearfix nullestablishment-section" id="sec-ee08">
  <div className="u-clearfix u-sheet u-valign-middle u-sheet-1">
    <div className="u-align-center u-container-style u-grey-5 u-group u-group-1">
      <div className="u-container-layout u-valign-middle u-container-layout-1">
        <h1 className="u-text u-text-default u-text-1">คุณไม่มีร้านค้า</h1>
        <a href="" onClick={() => this.props.history.push('/home')} className="u-btn u-btn-round u-button-style u-color-scheme-summer-time u-color-style-multicolor-1 u-palette-2-base u-radius-50 u-btn-1">กลับสู่หน้าแรก</a>
      </div>
    </div>
  </div>
</section>)}
