...
class Welcome extends Component {
  render() {
    return (<header className="w3-display-container w3-content w3-wide" style={{maxWidth: 1500}} >
  ...
  <img className="w3-image" src={Rooftop} alt="Architecture" width={1500} height={800} />
